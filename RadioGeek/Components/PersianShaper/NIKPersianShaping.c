 ...
 *	Persian version by Neeku Shamekhi
 *
...
CharRep charsMap[MAP_LENGTH] =
{
	...
	{ 0x0628, 0xFE8F, 0xFE91, 0xFE92, 0xFE90 }, /* BEH ﺏ - ﺑ - ﺒ - ﺐ */
	...
	{ 0x064A, 0xFEF1, 0xFEF3, 0xFEF4, 0xFEF2 }, /* YEH ﻱ - ﻳ - ﻴ - ﻲ */
	{ 0x06CC, 0xFEEF, 0xFEF3, 0xFEF4, 0xFEF0 }, /* Persian YEH */
	{ 0x067e, 0xFB56, 0xFB58, 0xFB59, 0xFB57 }, /* Persian PEH */
	{ 0x06a9, 0xFB8E, 0xFB90, 0xFB91, 0xFB8F }, /* Persian Kaaf */
	{ 0x0686, 0xFB7A, 0xFB7C, 0xFB7D, 0xFB7B }, /* Persian Cheh */
	{ 0x06AF, 0xFB92, 0xFB94, 0xFB95, 0xFB93 }, /* Persian Gaaf */
	{ 0x0698, 0xFB8A, NIL, NIL, 0xFB8B }, /* Persian jeh */
};
...
FriBidiChar* shape_arabic(FriBidiChar * str, int len)
{
	...
	for (int i = 0; i < len; i++)
	{
		...
		else
		{
			...
			if (current > 255)
			{
				//fprintf(stderr, "PersianShaper: Unknown Character [%d] 0x%04x\n", i, current);
			}
#endif
